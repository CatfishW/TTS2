...
async def lifespan(app: FastAPI):
    ...
    parser.add_argument("--cuda_kernel", action="store_true", default=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deepspeed", action="store_true", default=True, help="Use DeepSpeed")
    parser.add_argument("--cuda_kernel", action="store_true", default=True, help="Use CUDA kernel")
